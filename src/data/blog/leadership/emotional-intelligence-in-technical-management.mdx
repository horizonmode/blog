...
Typically my approach is to focus on the implementation, try to make the right decisions, deliver incrementally, and hope that things fall into place over time. 

However working as a systems architect, ehere are not responsible for a build, particularly in mixed delivery environments, my experience is that the technical side is often only half the battle. The harder part is sometimes aligning people, managing expectations, and navigating different perspectives across teams.

That’s where it could be usefu to consider emotional intelligence. 
