...
However, the minReplicas setting on the VPA currently prevents us from using this mode, as it requires at least 2 replicas 
to enable recreation of pods. Our options are to either:
...
In this case, the pod would presumably be a candidate for throttling or eviction anyway.